...
for training, then test interactions with a merged-training-unseen user or item
are filtered without being moved into train.  Conversion counts, hashes, ID checks, and the cold-start audit are documented
